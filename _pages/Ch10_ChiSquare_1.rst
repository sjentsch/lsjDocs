...
:doc:`Binomial distribution <Ch07_Probability_4>`. In other words, if the null
...
<Ch08_Estimation_3>` the binomial distribution starts to look pretty much
...
<Ch07_Probability_6>`, when you take a bunch of things that have a standard
...
remember back to :doc:`Other useful distributions <Ch07_Probability_6>`, I said
...
<Ch07_Probability_6>`, I was a bit vague about what “**degrees of freedom**”
...
<Ch09_HypothesisTesting>` the χ²-goodness-of-fit test is always a **one-sided
