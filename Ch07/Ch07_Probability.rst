...
of it everywhere. For instance, here is a tiny extract from a newspaper
...
everyday life, but let us have a think about what it entails. A polling
company has conducted a survey, usually a pretty big one because they
can afford it. I am too lazy to track down the original survey so let us
...
by 37\%, but it is a bit hard to say whether 29\% is plausible. We need
...
discussion of probability theory is basically background detail. There is
not a lot of statistics per se in this chapter, and you do not need to
...
so much of statistics, it is worth covering some of the basics.
