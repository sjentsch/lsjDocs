...
section :doc:`Using box plots to detect outliers <../Ch05/Ch05_Graphics_2>` in the
...
recoding a variable <../Ch06/Ch06_DataHandling_3>` and :doc:`Mathematical functions and
operations <../Ch06/Ch06_DataHandling_4>`, but I do want to make special note of one
