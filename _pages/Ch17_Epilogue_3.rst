...
<Ch08_Estimation>` I talked a little bit about the idea of unbiased estimators,
sampling distributions and so on. In chapter :doc:`Hypothesis testing
<Ch09_HypothesisTesting>` I talked about the theory of null hypothesis
...
:doc:`Bayesian statistics <Ch16_Bayes>` now presents the Bayesian perspective
...
-  **Bootstrapping.** Throughout the book, whenever I’ve introduced a
   ...
   analysis <Ch10_ChiSquare>`, I made reference to the known relationship
   between normal distributions and χ²-distributions (see chapter
   :doc:`Introduction to probability <Ch07_Probability>` to explain how we end
