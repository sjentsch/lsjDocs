...
analyse a subset of the data. Et cetera. In other words, there is a lot
...
much if you can not grasp it all at once, especially the later sections. The rest
of the book is only lightly reliant on this chapter so you can get away with
just understanding the basics. However, what you will probably find is that later
on you will need to flick back to this chapter in order to understand some of the
