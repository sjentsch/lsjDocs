...
any details, let us take a moment to get a sense of why we need
descriptive statistics. To do this, let us open the |aflsmall_margins|_
...
some nice pictures (chapter :doc:`../Ch05/Ch05_Graphics`).
Since the descriptive statistics are the easier of the two topics I will start
with those, but nevertheless I will show you a histogram of the ``afl.margins``
variable since it should help you get a sense of what the data we are trying to
describe actually look like, see :numref:`fig-aflMargins`. We will talk a lot
more about how to draw :doc:`histograms <../Ch05/Ch05_Graphics_1>`. For now,
it is enough to look at the histogram and note that it provides a fairly
