...
:doc:`Binomial distribution <../Ch07/Ch07_Probability_4>`. In other words, if
the null hypothesis is true, then it follows that our observed frequencies were
...
<../Ch07/Ch07_Probability_6>`, when you take a bunch of things that have a
...
remember back to :doc:`Other useful distributions <../Ch07/Ch07_Probability_6>`,
I said that if the number of things you’re adding up is *k*, then the degrees
of freedom for the resulting χ²-distribution is *k*. Yet, what I said at the
