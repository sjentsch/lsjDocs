...
reason. It is not easy, and while there are a lot of fairly standardised
...
exercise a certain amount of judgement when doing this. It is easy to get
lost in all the details of checking this thing or that thing, and it is
...
cover the full space of things you could do, but it is still much more
detailed than what I see a lot of people doing in practice, and even I
do not usually cover all of this in my intro stats class either. However,
I do think it is important that you get a sense of what tools are at your
disposal, so I will try to introduce a bunch of them here. Finally, I should
...
about them in an admirably clear fashion. I do not want to sound too gushy
...
points high influence, and it is why they are the biggest worry. We
...
predictors are all nice and uncorrelated with one another. If you have
