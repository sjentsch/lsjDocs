...
assumptions. In section :doc:`Model checking <../Ch12/Ch12_Regression_10>` we’ll talk a
...
-  *Normality*. Like many of the models in statistics, basic simple or multiple
   ...
   residuals <../Ch12/Ch12_Regression_10>`.
...
-  *Uncorrelated predictors*. The idea here is that, in a multiple
   ...
   section :doc:`Checking for collinearity <../Ch12/Ch12_Regression_10>`.
...
-  *No “bad” outliers*. Again, not actually a technical assumption of the model
   ...
   cases. See section :doc:`Three kinds of anomalous data <../Ch12/Ch12_Regression_10>`.
