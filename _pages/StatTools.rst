...
start with “χ² tests” (Chapter `Categorical data analysis`__) and “*t*-tests”
(Chapter `Comparing two means <Ch11_tTest.html#comparing-two-means>`__). Both
of these tools are very frequently used in scientific practice, and whilst
they’re not as powerful as “regression” (see Chapter `Correlation and linear
regression <Ch12_Regression.html#correlation-and-linear-regression>`__) and
“Analysis of Variance” (Chapters `Comparing several means (one-way ANOVA)
