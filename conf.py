...
exclude_patterns = ['.not_used', '_build', '_env', '_original', '**/Thumbs.db', '**/.DS_Store', 'README.*', '**/README.*']
...
html_title = 'Learning statistics with jamovi'
